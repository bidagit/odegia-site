...
const cardOff = "border-ink/12 bg-surface hover:border-petrol/50";
const cardOn = "border-petrol bg-petrol text-white";
      ...
      node: (
        ...
        >
          <div className="rounded-2xl border border-ink/12 bg-surface px-5 py-6">
            <div className="text-[34px] font-semibold tracking-[-0.03em] text-petrol">
              {r.heuresSemaine} h
            ...
            <input
              ...
              className="mt-5 w-full accent-[#0e4a52]"
            />
        ...
        >
          <div className="space-y-3">
            <input
              ...
              placeholder="Prénom"
              aria-label="Prénom"
              className="w-full rounded-2xl border border-ink/12 bg-surface px-5 py-4 text-[14.5px] outline-none focus:border-petrol"
            />
            <input
              type="email"
              value={email}
            ...
            <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-ink/12 bg-surface px-5 py-4">
              <input
                ...
                className="mt-0.5 h-4 w-4 shrink-0 accent-[#0e4a52]"
              />
    ...
    <div className="mx-auto max-w-2xl px-5 py-12 sm:px-8 md:py-16">
      ...
      <div className="mt-9 flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-full bg-petrol px-7 py-3.5 text-[14.5px] font-medium text-white transition-colors hover:bg-petrol-deep disabled:cursor-not-allowed disabled:opacity-35"
        >
    ...
    return (
      <div className="mx-auto max-w-2xl px-5 py-14 sm:px-8">
        ...
        <a
          ...
          className="mt-8 inline-block rounded-full border border-ink/15 px-6 py-3.5 text-[14px] font-medium transition-colors hover:border-petrol hover:text-petrol"
        >
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-12 sm:px-8 md:py-16">
      ...
      <h2 className="mt-4 text-[28px] font-semibold leading-[1.12] tracking-[-0.03em] md:text-[38px]">
        ...
        <span className="text-petrol">{heures(res.heuresMois)} heures</span> par
        mois, soit{" "}
        <span className="text-petrol">{euros(res.coutAnnuel)}</span> par an.
      </h2>
          ...
          {res.recommandees.map((l, i) => (
            <li
              ...
              className={`rounded-2xl border p-5 ${
                i === 0 ? "border-petrol bg-petrol/[0.06]" : "border-ink/12 bg-surface"
              }`}
            >
      ...
      <section className="mt-12 rounded-2xl bg-petrol p-7 text-white md:p-9">
        ...
        <p className="mt-5 text-[26px] font-semibold leading-tight tracking-[-0.02em] md:text-[32px]">
          ...
          <span className="text-ocre">{res.roiMois} mois</span>.
        </p>
      </section>
      ...
      <section className="mt-10">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-6 inline-block rounded-full bg-petrol px-7 py-3.5 text-[14.5px] font-medium text-white transition-colors hover:bg-petrol-deep"
        >
